...
candidate_sources <- candidate_sources %>%
  select(state, state_first_infection, iso_code, country, region, reporting_level, strain_eng, sero_sub_genotype_eng,  disease_eng, Latitude, Longitude, Outbreak_start_date, level3_name, level2_name, level1_name)
```
